...
def yonetici_anasayfa_ekrani(sonuc,giris_cursor,db):
    ...
    altBaslik_label = Label(altBaslik_frame,bg="#9A3223",font=("Arial", 16, "bold italic"),text="Ad-Soyad: " +str(isim[0][0])+" "+str(isim[0][1])+" (id="+str(isim[0][2])+")",fg="white")
